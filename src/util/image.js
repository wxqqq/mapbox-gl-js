...
class AlphaImage {
    ...
    static create(size: Size, data?: Uint8Array): AlphaImage {
        return (createImage(size, 1, data): any);
    }
...
class RGBAImage {
    ...
    static create(size: Size, data?: Uint8Array): RGBAImage {
        return (createImage(size, 4, data): any);
    }
